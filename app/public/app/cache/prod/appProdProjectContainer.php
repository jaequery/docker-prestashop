...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'db', 'port' => '', 'dbname' => 'lemp', 'user' => 'root', 'password' => 'changeme', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_40fabedc8b096965a5f5b5d485f4ed5dcc60d5e6a4ccbf376021307b5c228aae');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('sJMZBN5tpno2GevV0buVOv770PNMdBqZaaAHaqGYQqt39KVA9gsyAj5A');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5914de4fc43003.45087644')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'sJMZBN5tpno2GevV0buVOv770PNMdBqZaaAHaqGYQqt39KVA9gsyAj5A',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-05-11',
            'locale' => 'en-US',
            'cookie_key' => '88RrIonrWXnPDey4hcEtOIcSBpOwVwsg9wEW8ttTbcLkex2oae27hADi',
            'cookie_iv' => '7UdHRjJH',
            'new_cookie_key' => 'def00000903b045c5775750beecaf35069d6a6fa795168a0115e5cd1ba75c2fe3959059f464d024196e3c6a6552db2c6c163c9ecb82071395694395c85f08e4dea199a73',
            ...
            'kernel.secret' => 'sJMZBN5tpno2GevV0buVOv770PNMdBqZaaAHaqGYQqt39KVA9gsyAj5A',
