...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  array (
    ...
    '%1$s cannot be saved' => '%1$s cannot be saved',
    ...
    'Is an unauthorized keyword.' => 'Is an unauthorized keyword.',
  ...
  array (
    ...
    'Enable or disable the product on your shop: ALT+SHIFT+0' => 'Enable or disable the product on your shop: ALT+SHIFT+O',
    ...
    'To add combinations, enter the wanted attributes (like "size" or "color") and their respective values ("XS", "red", "all", etc.) in the field below; or select it in the right column. Then click on "Generate": it will automatically create all the combinations for you! <br> If you haven’t got any attributes yet, you should first create some in [1]Attributes & Features[/1].' => 'To add combinations, you first need to create proper attributes and values in [1]Attributes & Features[/1]. <br> When done, you may enter the wanted attributes (like "size" or "color") and their respective values ("XS", "red", "all", etc.) in the field below; or simply select them from the right column. Then click on "Generate": it will automatically create all the combinations for you!',
  ...
  array (
    ...
    'Parent CMS Category' => 'Parent CMS Category',
    'Add new category' => 'Add new category',
  ...
  'AdminDesignHelp' => 
  array (
    'Add new CMS category' => 'Add new CMS category',
    'Add new CMS page' => 'Add new CMS page',
    'To add "tags" click in the field, write something, and then press "Enter."' => 'To add "tags" click in the field, write something, and then press "Enter."',
  ...
  array (
    ...
    'Provide the State name to be display in addresses and on invoices.' => 'Provide the state name to be displayed in addresses and on invoices.',
  ...
  array (
    ...
    'Translation unsuccessfully updated' => 'Failed to update translation.',
  ),
  ...
  array (
    ...
    'The following module(s) were not upgraded successfully: %s.' => 'The following module(s) were not upgraded successfully: %s.',
  ...
  array (
    ...
    '%1$s %2$s has not placed any orders yet' => '%1$s %2$s has not placed any orders yet',
    ...
    'Sent on' => 'Sent on',
    '%1$s %2$s has never contacted you' => '%1$s %2$s has never contacted you',
    '%1$s %2$s has no discount vouchers' => '%1$s %2$s has no discount vouchers',
    ...
    '%1$s %2$s has not registered any addresses yet' => '%1$s %2$s has not registered any addresses yet',
    'Edit' => 'Edit',
    'List' => 'List',
    ...
    'Delete' => 'Delete',
    'You do not have the right permission' => 'You do not have the right permission',
    'File %1$s exceeds the size allowed by the server. The limit is set to %2$d MB.' => 'File %1$s exceeds the size allowed by the server. The limit is set to %2$d MB.',
    'The file is too large. Maximum size allowed is: %1$d kB. The file you are trying to upload is %2$d kB.' => 'The file is too large. Maximum size allowed is: %1$d kB. The file you are trying to upload is %2$d kB.',
    'File copy failed' => 'File copy failed',
    'The price rule has successfully updated' => 'The price rule has successfully updated',
    'It is not possible to delete a combination while it still has some quantities in the Advanced Stock Management. You must delete its stock first.' => 'It is not possible to delete a combination while it still has some quantities in the Advanced Stock Management. You must delete its stock first.',
    'Error while deleting the stock' => 'Error while deleting the stock',
    'You cannot delete this attribute.' => 'You cannot delete this attribute.',
    'You do not have permission to delete this.' => 'You do not have permission to delete this.',
    'You cannot make this the default attribute.' => 'You cannot make this the default attribute.',
    'Products must be in at least one category.' => 'Products must be in at least one category.',
    'This product must be in the default category.' => 'This product must be in the default category.',
    'Filter by category' => 'Filter by category',
    'Out of stock items' => 'Out of stock items',
    'Average Gross Margin %' => 'Average Gross Margin %',
    '30 days' => '30 days',
    'Disabled Products' => 'Disabled Products',
    'Your product will be saved as a draft.' => 'Your product will be saved as a draft.',
    'Save and preview' => 'Save and preview',
    'Add new product' => 'Add new product',
    'Preview' => 'Preview',
    'This will copy the images too. If you wish to proceed, click "Yes". If not, click "No".' => 'This will copy the images too. If you wish to proceed, click "Yes". If not, click "No".',
    ...
    'All groups' => 'All groups',
    'All customers' => 'All customers',
    'No specific prices.' => 'No specific prices.',
    'Priority management' => 'Priority management',
    'Sometimes one customer can fit into multiple price rules. Priorities allow you to define which rule applies to the customer.' => 'Sometimes one customer can fit into multiple price rules. Priorities allow you to define which rule applies to the customer.',
    'Priorities' => 'Priorities',
    'Apply to all products' => 'Apply to all products',
    ...
    'Impact on weight' => 'Impact on weight',
    'EAN-13' => 'EAN-13',
    'Undefined action' => 'Undefined action',
    'Undefined value' => 'Undefined value',
    'Incorrect value' => 'Incorrect value',
    'Not possible if advanced stock management is disabled. ' => ' ',
    'You cannot use advanced stock management for this pack because' => 'You cannot use advanced stock management for this pack because',
    '- advanced stock management is not enabled for these products' => '- advanced stock management is not enabled for these products',
    '- you have chosen to decrement products quantities.' => '- you have chosen to decrement products quantities.',
    '- advanced stock management is enabled for the pack' => '- advanced stock management is enabled for the pack',
    'Undefined id product attribute' => 'Undefined id product attribute',
    'Default category' => 'Default category',
    'Consider changing the default category.' => 'Consider changing the default category.',
    'Mark the checkbox of each categories in which this product will appear.' => 'Mark the checkbox of each categories in which this product will appear.',
    'Back to list' => 'Back to list',
    ...
    'Current version: %s' => 'Current version: %s',
    'All modules updated successfully.' => 'All modules updated successfully.',
    'No file upgrades applied (none exist).' => 'No file upgrades applied (none exist).',
    '%1$s: %2$s' => '%1$s: %2$s',
    'The following module(s) were upgraded successfully: %s.' => 'The following module(s) were upgraded successfully: %s.',
    ...
    'Save and stay' => 'Save and stay',
    'Supply order status' => 'Supply order status',
    'All Warehouses' => 'All Warehouses',
    'Price (tax excl.)' => 'Price (tax excl.)',
    'EAN-13 or JAN barcode' => 'EAN-13 or JAN barcode',
    'UPC barcode' => 'UPC barcode',
    'Unit price (tax excl.)' => 'Unit price (tax excl.)',
    'You need to activate the Advanced Stock Management feature prior to using this feature.' => 'You need to activate the Advanced Stock Management feature prior to using this feature.',
    'You need to activate advanced stock management prior to using this feature.' => 'You need to activate advanced stock management prior to using this feature.',
    'Employee' => 'Employee',
    'Creation' => 'Creation',
    'Last modification' => 'Last modification',
    'Delivery (expected)' => 'Delivery (expected)',
    'Add new supply order' => 'Add new supply order',
    'Add new supply order template' => 'Add new supply order template',
    'Stock: Create a new supply order' => 'Stock: Create a new supply order',
    'Stock: Manage supply orders' => 'Stock: Manage supply orders',
    'template' => 'template',
    'You must have at least one warehouse. See Stock/Warehouses' => 'You must have at least one warehouse. See Stock/Warehouses',
    'The reference number for your order.' => 'The reference number for your order.',
    'Select the supplier you\'ll be purchasing from.' => 'Select the supplier you\'ll be purchasing from.',
    'Warning: All products already added to the order will be removed.' => 'Warning: All products already added to the order will be removed.',
    'Which warehouse will the order be sent to?' => 'Which warehouse will the order be sent to?',
    'The currency of the order.' => 'The currency of the order.',
    'Order Language' => 'Order Language',
    'The language of the order.' => 'The language of the order.',
    'Global discount percentage' => 'Global discount percentage',
    'This is the global discount percentage for the order.' => 'This is the global discount percentage for the order.',
    'Automatically load products' => 'Automatically load products',
    'This will reset the order.' => 'This will reset the order.',
    'If a value specified, each of your current product (from the selected supplier and warehouse) with a quantity lower than or equal to this value will be loaded. This means that PrestaShop will pre-fill this order with the products that are low on quantity.' => 'If a value specified, each of your current product (from the selected supplier and warehouse) with a quantity lower than or equal to this value will be loaded. This means that PrestaShop will pre-fill this order with the products that are low on quantity.',
    'Expected delivery date' => 'Expected delivery date',
    'The expected delivery date for this order is...' => 'The expected delivery date for this order is...',
    'If you wish to order products, they have to be available for the specified supplier/warehouse.' => 'If you wish to order products, they have to be available for the specified supplier/warehouse.',
    'See Catalog/Products/[Your Product]/Suppliers & Warehouses.' => 'See Catalog/Products/[Your Product]/Suppliers & Warehouses.',
    'Changing the currency or the supplier will reset the order.' => 'Changing the currency or the supplier will reset the order.',
    'Please note that you can only order from one supplier at a time.' => 'Please note that you can only order from one supplier at a time.',
    'Export Orders (CSV)' => 'Export Orders (CSV)',
    'Export Orders Details (CSV)' => 'Export Orders Details (CSV)',
    'Add New' => 'Add New',
    'This interface allows you to manage supply orders.' => 'This interface allows you to manage supply orders.',
    'You can create pre-filled order templates, from which you can build actual orders much quicker.' => 'You can create pre-filled order templates, from which you can build actual orders much quicker.',
    'You must choose at least one warehouse before creating supply orders. For more information, see Stock/Warehouses.' => 'You must choose at least one warehouse before creating supply orders. For more information, see Stock/Warehouses.',
    'There is nothing to export as a CSV file.' => 'There is nothing to export as a CSV file.',
    'Stock: Supply order templates' => 'Stock: Supply order templates',
    'Add new template' => 'Add new template',
    'Be careful when changing status. Some of those changes cannot be canceled. ' => ' ',
    'Stock: Change supply order status #%s' => 'Stock: Change supply order status #%s',
    'Supplier reference' => 'Supplier reference',
    'Quantity received today?' => 'Quantity received today?',
    'The quantity of supplies that you received today.' => 'The quantity of supplies that you received today.',
    'Quantity received' => 'Quantity received',
    'The quantity of supplies that you received so far (today and the days before, if it applies).' => 'The quantity of supplies that you received so far (today and the days before, if it applies).',
    'Quantity expected' => 'Quantity expected',
    'Quantity left' => 'Quantity left',
    'The quantity of supplies left to receive for this order.' => 'The quantity of supplies left to receive for this order.',
    'Update selected' => 'Update selected',
    'Receipt of products for supply order #%s' => 'Receipt of products for supply order #%s',
    'This interface allows you to update the quantities of this ongoing order.' => 'This interface allows you to update the quantities of this ongoing order.',
    'Be careful! Once you update, you cannot go back unless you add new negative stock movements.' => 'Be careful! Once you update, you cannot go back unless you add new negative stock movements.',
    'A green line means that you\'ve received exactly the quantity you expected. A red line means that you\'ve received more than expected.' => 'A green line means that you\'ve received exactly the quantity you expected. A red line means that you\'ve received more than expected.',
    'Field: %s' => 'Field: %s',
    'supply_orders' => 'supply_orders',
    'supply_orders_details' => 'supply_orders_details',
    'supply_order' => 'supply_order',
    'Update ongoing receipt of products' => 'Update ongoing receipt of products',
    'Change status' => 'Change status',
    'Use this template to create a supply order' => 'Use this template to create a supply order',
    'Are you sure you want to use this template?' => 'Are you sure you want to use this template?',
    'Last update' => 'Last update',
    'This interface allows you to display detailed information about your order.' => 'This interface allows you to display detailed information about your order.',
    'This interface allows you to display detailed information about your order template.' => 'This interface allows you to display detailed information about your order template.',
    'Details on supply order #%s' => 'Details on supply order #%s',
    'Details on supply order template #%s' => 'Details on supply order template #%s',
    'Discount percentage' => 'Discount percentage',
    'Discount value (tax excl.)' => 'Discount value (tax excl.)',
    'Price with product discount (tax excl.)' => 'Price with product discount (tax excl.)',
    'Tax value' => 'Tax value',
    'Price (tax incl.)' => 'Price (tax incl.)',
    ...
    'Recycled package' => 'Recycled package',
    ...
    'Delete selected' => 'Delete selected',
    'Delete selected items?' => 'Delete selected items?',
    'You need to activate advanced stock management before using this feature.' => 'You need to activate advanced stock management before using this feature.',
    'Management type' => 'Management type',
    'Manager' => 'Manager',
    'Phone Number' => 'Phone Number',
    'Add new warehouse' => 'Add new warehouse',
    'This interface allows you to manage your warehouses.' => 'This interface allows you to manage your warehouses.',
    'Before adding stock in your warehouses, you should check the default currency used.' => 'Before adding stock in your warehouses, you should check the default currency used.',
    'You should also check the management type (according to the law in your country), the valuation currency and its associated carriers and shops.' => 'You should also check the management type (according to the law in your country), the valuation currency and its associated carriers and shops.',
    'You can also see detailed information about your stock, such as its overall value, the number of products and quantities stored, etc.' => 'You can also see detailed information about your stock, such as its overall value, the number of products and quantities stored, etc.',
    'Be careful! Products from different warehouses will need to be shipped in different packages.' => 'Be careful! Products from different warehouses will need to be shipped in different packages.',
    'Stock: Create a warehouse' => 'Stock: Create a warehouse',
    'Stock: Warehouse management' => 'Stock: Warehouse management',
    'Warehouse information' => 'Warehouse information',
    'Reference for this warehouse.' => 'Reference for this warehouse.',
    'Name of this warehouse.' => 'Name of this warehouse.',
    'Phone' => 'Phone',
    'Phone number for this warehouse.' => 'Phone number for this warehouse.',
    'Mobile phone' => 'Mobile phone',
    'Mobile phone number for this supplier.' => 'Mobile phone number for this supplier.',
    'Complementary address (optional).' => 'Complementary address (optional).',
    'Zip/postal code' => 'Zip/postal code',
    'Country of location of the warehouse.' => 'Country of location of the warehouse.',
    'State' => 'State',
    'Carriers' => 'Carriers',
    'Associated carriers.' => 'Associated carriers.',
    'You can choose which carriers can ship orders from particular warehouses.' => 'You can choose which carriers can ship orders from particular warehouses.',
    'If you do not select any carrier, all the carriers will be able to ship from this warehouse.' => 'If you do not select any carrier, all the carriers will be able to ship from this warehouse.',
    'If no carrier is selected, all the carriers will be allowed to ship from this warehouse. Use CTRL+Click to select more than one carrier.' => 'If no carrier is selected, all the carriers will be allowed to ship from this warehouse. Use CTRL+Click to select more than one carrier.',
    'Shop association' => 'Shop association',
    'Inventory valuation method. Be careful! You won\'t be able to change this value later!' => 'Inventory valuation method. Be careful! You won\'t be able to change this value later!',
    'Weighted Average' => 'Weighted Average',
    'First In, First Out' => 'First In, First Out',
    'Last In, First Out' => 'Last In, First Out',
    'Stock valuation currency' => 'Stock valuation currency',
    'Be careful! You won\'t be able to change this value later!' => 'Be careful! You won\'t be able to change this value later!',
    'WA: Weighted Average' => 'WA: Weighted Average',
    'FIFO: First In, First Out' => 'FIFO: First In, First Out',
    'LIFO: Last In, First Out' => 'LIFO: Last In, First Out',
    'It is not possible to delete a warehouse when there are products in it.' => 'It is not possible to delete a warehouse when there are products in it.',
    'It is not possible to delete a Warehouse if it has pending supply orders.' => 'It is not possible to delete a Warehouse if it has pending supply orders.',
    'UPC' => 'UPC',
    'EAN13' => 'EAN13',
    'Quantity' => 'Quantity',
    'Save order' => 'Save order',
    'Save order and stay' => 'Save order and stay',
    'Supplier Reference' => 'Supplier Reference',
    'Tax rate' => 'Tax rate',
    'Manage the products you want to order from the supplier.' => 'Manage the products you want to order from the supplier.',
    'To add a product to the order, type the first letters of the product name, then select it from the drop-down list.' => 'To add a product to the order, type the first letters of the product name, then select it from the drop-down list.',
    'Add a product to the supply order' => 'Add a product to the supply order',
    'Unit Price (tax excl.)' => 'Unit Price (tax excl.)',
    'Discount rate' => 'Discount rate',
    ...
    'Increase' => 'Increase',
    'Decrease' => 'Decrease',
    'The name of this product is not available. It may have been deleted from the system.' => 'The name of this product is not available. It may have been deleted from the system.',
    'Export this list as CSV' => 'Export this list as CSV',
    'This interface allows you to display the stock movement for a selected warehouse.' => 'This interface allows you to display the stock movement for a selected warehouse.',
    'EAN 13' => 'EAN 13',
    'Sign' => 'Sign',
    'Stock movement' => 'Stock movement',
    'Export (CSV)' => 'Export (CSV)',
    'There is nothing to export as a CSV.' => 'There is nothing to export as a CSV.',
    'stock_mvt' => 'stock_mvt',
    'Default label for increasing stock' => 'Default label for increasing stock',
    'Default label for decreasing stock' => 'Default label for decreasing stock',
    'Default label for decreasing stock when a customer order is shipped' => 'Default label for decreasing stock when a customer order is shipped',
    'Default label for increasing stock when a supply order is received' => 'Default label for increasing stock when a supply order is received',
    'Stock: Add stock movement label' => 'Stock: Add stock movement label',
    'Stock Movement label' => 'Stock Movement label',
    'Increase stock' => 'Increase stock',
    'Decrease stock' => 'Decrease stock',
    'Does this label indicate a stock increase or a stock decrease?' => 'Does this label indicate a stock increase or a stock decrease?',
    'Supply Order Status' => 'Supply Order Status',
    'Color' => 'Color',
    'Status will be highlighted in this color. HTML colors only.' => 'Status will be highlighted in this color. HTML colors only.',
    'Editable' => 'Editable',
    'Is it is possible to edit the order? Keep in mind that an editable order cannot be sent to the supplier.' => 'Is it is possible to edit the order? Keep in mind that an editable order cannot be sent to the supplier.',
    'Delivery note' => 'Delivery note',
    'Is it possible to generate a delivery note for the order?' => 'Is it possible to generate a delivery note for the order?',
    'Delivery status' => 'Delivery status',
    'Indicates whether the supplies have been either partially or completely received. This will allow you to know if ordered products have to be added to the corresponding warehouse.' => 'Indicates whether the supplies have been either partially or completely received. This will allow you to know if ordered products have to be added to the corresponding warehouse.',
    'Awaiting delivery' => 'Awaiting delivery',
    'Indicates that you are awaiting delivery of supplies.' => 'Indicates that you are awaiting delivery of supplies.',
    'Stock: Add supply order status' => 'Stock: Add supply order status',
    'Stock: Update supply order status' => 'Stock: Update supply order status',
    'This interface allows you to configure your supply order status and stock movement labels.' => 'This interface allows you to configure your supply order status and stock movement labels.',
    'Stock: Stock movement labels' => 'Stock: Stock movement labels',
    'Stock: Supply order status' => 'Stock: Supply order status',
    'Supply order can be edited?' => 'Supply order can be edited?',
    'Delivery note is available?' => 'Delivery note is available?',
    'Delivery is expected?' => 'Delivery is expected?',
    'Stock has been delivered?' => 'Stock has been delivered?',
    'Order is closed?' => 'Order is closed?',
    'You need to activate the Advanced Stock Management feature before you can use this feature.' => 'You need to activate the Advanced Stock Management feature before you can use this feature.',
    'The status has been updated successfully.' => 'The status has been updated successfully.',
    'An error occurred while updating this meta.' => 'An error occurred while updating this meta.',
    'Status' => 'Status',
    'Warehouse' => 'Warehouse',
    'Date' => 'Date',
    'Amount' => 'Amount',
    ...
    'Quantity sold' => 'Quantity sold',
    'Quantity sold during the defined period.' => 'Quantity sold during the defined period.',
    'Coverage' => 'Coverage',
    'Days left before your stock runs out.' => 'Days left before your stock runs out.',
    'Physical (usable) quantity.' => 'Physical (usable) quantity.',
    'One week' => 'One week',
    'Two weeks' => 'Two weeks',
    ...
    'One year' => 'One year',
    'Stock coverage' => 'Stock coverage',
    'Considering the coverage period chosen and the quantity of products/combinations that you sold.' => 'Considering the coverage period chosen and the quantity of products/combinations that you sold.',
    'This interface gives you an idea of when a product will run out of stock.' => 'This interface gives you an idea of when a product will run out of stock.',
    'See details' => 'See details',
    'Valuation' => 'Valuation',
    'Total value of the physical quantity. The sum (for all prices) is not available for all warehouses, please filter by warehouse.' => 'Total value of the physical quantity. The sum (for all prices) is not available for all warehouses, please filter by warehouse.',
    'Physical quantity' => 'Physical quantity',
    'Usable quantity' => 'Usable quantity',
    'Real quantity' => 'Real quantity',
    'Physical quantity (usable) - Client orders + Supply Orders' => 'Physical quantity (usable) - Client orders + Supply Orders',
    'Instant stock status' => 'Instant stock status',
    'Export Quantities (CSV)' => 'Export Quantities (CSV)',
    'Export Prices (CSV)' => 'Export Prices (CSV)',
    'This interface allows you to display detailed information about your stock per warehouse.' => 'This interface allows you to display detailed information about your stock per warehouse.',
    'There is nothing to export as CSV.' => 'There is nothing to export as CSV.',
    'stock_instant_state_quantities' => 'stock_instant_state_quantities',
    'stock_instant_state_prices' => 'stock_instant_state_prices',
    'Product reference' => 'Product reference',
    'Quantity total for all warehouses.' => 'Quantity total for all warehouses.',
    'The product was successfully added to your stock.' => 'The product was successfully added to your stock.',
    'The product was successfully removed from your stock.' => 'The product was successfully removed from your stock.',
    'The transfer was successfully completed.' => 'The transfer was successfully completed.',
    'This interface allows you to manage product stock and their variations.' => 'This interface allows you to manage product stock and their variations.',
    'Through this interface, you can increase and decrease product stock for an given warehouse.' => 'Through this interface, you can increase and decrease product stock for an given warehouse.',
    'Furthermore, you can move product quantities between warehouses, or within one warehouse.' => 'Furthermore, you can move product quantities between warehouses, or within one warehouse.',
    'If you want to increase quantities of multiple products at once, you can use the "Supply orders" page under the "Stock" menu.' => 'If you want to increase quantities of multiple products at once, you can use the "Supply orders" page under the "Stock" menu.',
    'Finally, you need to provide the quantity that you\'ll be adding: "Usable for sale" means that this quantity will be available in your shop(s), otherwise it will be considered reserved (i.e. for other purposes).' => 'Finally, you need to provide the quantity that you\'ll be adding: "Usable for sale" means that this quantity will be available in your shop(s), otherwise it will be considered reserved (i.e. for other purposes).',
    'You must choose a warehouses before adding stock. See Stock/Warehouses.' => 'You must choose a warehouses before adding stock. See Stock/Warehouses.',
    'Moving the mouse cursor over the quantity and price fields will give you the details about the last stock movement.' => 'Moving the mouse cursor over the quantity and price fields will give you the details about the last stock movement.',
    'Add a product to your stock.' => 'Add a product to your stock.',
    'Quantity to add' => 'Quantity to add',
    'Indicate the physical quantity of this product that you want to add.' => 'Indicate the physical quantity of this product that you want to add.',
    'Last physical quantity added: %s items (usable for sale: %s).' => 'Last physical quantity added: %s items (usable for sale: %s).',
    'Usable for sale?' => 'Usable for sale?',
    'Is this quantity ready to be displayed in your shop, or is it reserved in the warehouse for other purposes?' => 'Is this quantity ready to be displayed in your shop, or is it reserved in the warehouse for other purposes?',
    'Please select the warehouse that you\'ll be adding products to.' => 'Please select the warehouse that you\'ll be adding products to.',
    'Unit purchase price or unit manufacturing cost for this product (tax excl.).' => 'Unit purchase price or unit manufacturing cost for this product (tax excl.).',
    'Last unit price (tax excl.): %s.' => 'Last unit price (tax excl.): %s.',
    'The currency associated to the product unit price.' => 'The currency associated to the product unit price.',
    'Label used in stock movements.' => 'Label used in stock movements.',
    'Add to stock' => 'Add to stock',
    'Remove the product from your stock.' => 'Remove the product from your stock.',
    'Quantity to remove' => 'Quantity to remove',
    'Indicate the physical quantity of this product that you want to remove.' => 'Indicate the physical quantity of this product that you want to remove.',
    'Usable for sale' => 'Usable for sale',
    'Do you want to remove this quantity from the usable quantity (yes) or the physical quantity (no)?' => 'Do you want to remove this quantity from the usable quantity (yes) or the physical quantity (no)?',
    'Select the warehouse you\'d like to remove the product from.' => 'Select the warehouse you\'d like to remove the product from.',
    'Remove from stock' => 'Remove from stock',
    'Transfer a product from one warehouse to another' => 'Transfer a product from one warehouse to another',
    'Quantity to transfer' => 'Quantity to transfer',
    'Indicate the physical quantity of this product that you want to transfer.' => 'Indicate the physical quantity of this product that you want to transfer.',
    'Source warehouse' => 'Source warehouse',
    'Select the warehouse you\'d like to transfer the product from.' => 'Select the warehouse you\'d like to transfer the product from.',
    'Is this product usable for sale in your source warehouse?' => 'Is this product usable for sale in your source warehouse?',
    'Is this the usable quantity for sale?' => 'Is this the usable quantity for sale?',
    'Destination warehouse' => 'Destination warehouse',
    'Select the warehouse you\'d like to transfer your product(s) to. ' => ' ',
    'Is this product usable for sale in your destination warehouse?' => 'Is this product usable for sale in your destination warehouse?',
    'Do you want it to be for sale/usable?' => 'Do you want it to be for sale/usable?',
    'Transfer' => 'Transfer',
    'Stock: Add a product' => 'Stock: Add a product',
    'Stock: Remove a product' => 'Stock: Remove a product',
    'Stock: Transfer a product' => 'Stock: Transfer a product',
    'Quantitity total for all warehouses.' => 'Total quantity for all warehouses.',
    'Add stock' => 'Add stock',
    ...
    'Phone:' => 'Phone:',
    'Shops' => 'Shops',
    'The following are the shops associated with this warehouse.' => 'The following are the shops associated with this warehouse.',
    'Currently there is no shop associated with this warehouse.' => 'Currently there is no shop associated with this warehouse.',
    'See products details' => 'See products details',
    'History' => 'History',
    'See warehouse\'s activity details' => 'See warehouse\'s activity details',
    'This warehouse does not exist.' => 'This warehouse does not exist.',
    'Supplier' => 'Supplier',
    'Features' => 'Features',
    ...
    'Ranges' => 'Ranges',
    'Validate' => 'Validate',
    'Please validate the last range before create a new one.' => 'Please validate the last range before create a new one.',
    ...
    'Total (tax excl.)' => 'Total (tax excl.)',
    'Total with discount (tax excl.)' => 'Total with discount (tax excl.)',
    'Total Tax' => 'Total Tax',
    'Total (tax incl.)' => 'Total (tax incl.)',
    ...
    'Products:' => 'Products:',
    'Suppliers' => 'Suppliers',
    'The cart must contain at least' => 'The cart must contain at least',
    ...
    'If you don\'t select "Free shipping," the normal shipping cost will be applied.' => 'If you don\'t select "Free shipping," the normal shipping cost will be applied.',
    ...
    'you must first create a new language.' => 'you must first create a new language.',
    ...
    'Contact Us!' => 'Contact Us!',
    'You are currently connected as %s' => 'You are currently connected as %s',
    ...
    'Connect your shop with PrestaShop\'s marketplace in order to automatically import all your Addons purchases.' => 'Connect your shop with PrestaShop\'s marketplace in order to automatically import all your Addons purchases.',
    ...
    'Current order status: %s' => 'Current order status: %s',
    'Choose the new status for your order' => 'Choose the new status for your order',
    'Print the supply order form' => 'Print the supply order form',
    'Click here to download the supply order form.' => 'Click here to download the supply order form.',
    'Down' => 'Down',
    'Up' => 'Up',
    'This tax only' => 'This tax only',
    'Combine' => 'Combine',
    ...
    'Quick Access' => 'Quick Access',
    'Have you checked your [1][2]abandonned carts[/2][/1]?' => 'Have you checked your [1][2]abandoned carts[/2][/1]?',
    'from' => 'from',
    'Debug mode' => 'Debug mode',
    'Your shop is in maintenance.' => 'Your shop is in maintenance.',
    'Your visitors and customers cannot access your shop while in maintenance mode.%s To manage the maintenance settings, go to Preferences > Maintenance.' => 'Your visitors and customers cannot access your shop while in maintenance mode.%s To manage the maintenance settings, go to Shop Parameters > Maintenance tab.',
  ...
  array (
    ...
    'A module can be already installed for you, free to install or paying - browse our selection to see what\'s available!' => 'Some modules are already pre-installed, others may be free or paid modules - browse your selection and find out what is available!',
    'Welcome' => 'Welcome',
    'Continue' => 'Continue',
